      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="max-w-3xl mx-auto text-center mb-16">
          ...
          <p className="text-xl text-gray-600">
            Solusi digital komprehensif untuk memenuhi kebutuhan bisnis Anda
          </p>
        </div>
        ...
        <div className="mb-20">
          <div className="max-w-3xl mx-auto text-center mb-12">
            ...
            <p className="text-xl text-gray-600">
              Proses pengembangan kami berfokus pada kebutuhan bisnis Anda
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-lg shadow-md text-center">
              ...
              <p className="text-gray-600">
                Kami memahami kebutuhan dan tujuan bisnis Anda untuk merancang solusi yang tepat
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-lg shadow-md text-center">
              ...
              <p className="text-gray-600">
                Tim ahli kami bekerja mengembangkan solusi yang sesuai dengan kebutuhan Anda
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-lg shadow-md text-center">
              ...
              <p className="text-gray-600">
                Kami melakukan deployment dan memastikan semua berjalan dengan baik
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mb-20">
          <FAQ 
            ...
            description="Jawaban untuk pertanyaan umum tentang layanan kami"
            items={faqItems} 
          />
        </div>
        ...
        <div className="bg-blue-600 rounded-xl p-8 md:p-12 text-center text-white">
          ...
          <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
            Hubungi kami untuk konsultasi gratis dan diskusikan kebutuhan bisnis Anda
          </p>
          <Link to="/kontak">
